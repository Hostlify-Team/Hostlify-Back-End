...
namespace Hostlify.Infraestructure.Migrations
{
    ...
    [Migration("20230504150448_CleaningServiceTable")]
    partial class CleaningServiceTable
    {
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.CleaningServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 4, 47, 903, DateTimeKind.Local).AddTicks(9860));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.FoodServices", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 4, 47, 903, DateTimeKind.Local).AddTicks(9227));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.History", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 4, 47, 903, DateTimeKind.Local).AddTicks(8266));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.Room", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 4, 47, 903, DateTimeKind.Local).AddTicks(7373));
            ...
            modelBuilder.Entity("Hostlify.Infraestructure.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 4, 47, 903, DateTimeKind.Local).AddTicks(5378));
